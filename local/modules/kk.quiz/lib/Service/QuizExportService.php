...
final class QuizExportService
{
    ...
    private function mapResult(array $element, array $properties): array
    {
        return [
            ...
            'badge_text' => (string)$this->getPropertyValue($properties, 'KK_RESULT_BADGE'),
            'reason_text' => (string)$this->getPropertyValue($properties, 'KK_RESULT_WHY_TEXT'),
            'fit_text' => (string)$this->getPropertyValue($properties, 'KK_RESULT_FIT_TEXT'),
            'build_text' => (string)$this->getPropertyValue($properties, 'KK_RESULT_SPECS_TEXT'),
            'budget_text' => (string)$this->getPropertyValue($properties, 'KK_RESULT_BUDGET_TEXT'),
            ...
            'form_subtitle' => (string)$this->getPropertyValue($properties, 'KK_RESULT_FORM_INTRO'),
            ...
            'secondary_cta' => [
                'text' => (string)$this->getPropertyValue($properties, 'KK_RESULT_SECONDARY_CTA_TEXT'),
                'url' => (string)$this->getPropertyValue($properties, 'KK_RESULT_SECONDARY_CTA_LINK'),
                'target' => $this->normalizeCtaTarget($this->getEnumXmlId($properties['KK_RESULT_SECONDARY_CTA_TARGET'] ?? [])),
            ],
