...
final class ElementFormAssets
{
    ...
    private static function renderScript(array $settings): string
    {
        return '(() => {'
            ...
            . 'if (event.target && event.target.matches(`[name^="PROPERTY[${settings.entityTypePropertyId}]"]`)) applyVisibility();'
            . '});'
