...
final class SectionFormAssets
{
    ...
    private static function renderScript(array $section): string
    {
        return '(() => {'
            ...
            . 'content.appendChild(createExample("Popup-компонент", popupComponentCode, "Добавьте этот код один раз на страницу или в шаблон сайта, где должен открываться popup."));'
            . 'content.appendChild(createExample("Ссылка открытия popup", popupLink, "Работает на страницах, где подключён popup-компонент."));'
            . 'content.appendChild(createExample("URL-вариант для popup", popupUrl, "Автоматически откроет popup, если на странице подключён popup-компонент."));'
            . 'return content;'
            . '};'
            . 'const hideEmbedTab = () => {'
