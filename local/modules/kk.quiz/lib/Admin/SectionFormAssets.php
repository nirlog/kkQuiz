...
final class SectionFormAssets
{
    ...
    private static function renderScript(array $section): string
    {
        return '(() => {'
            ...
            . 'const componentCode = `<?$APPLICATION->IncludeComponent("kk:quiz", ".default", ["QUIZ_CODE" => "${section.code}"]);?>`;'
            ...
            . '};'
            . 'const createExample = (title, value) => {'
            ...
            . 'content.appendChild(createExample("Код компонента", componentCode));'
            . 'content.appendChild(createExample("Ссылка для popup", popupLink));'
            . 'content.appendChild(createExample("URL-вариант для popup", popupUrl));'
            . 'return content;'
            . '};'
            . 'const hideEmbedTab = () => {'
