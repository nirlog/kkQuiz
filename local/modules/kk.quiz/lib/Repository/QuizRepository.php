...
final class QuizRepository
{
    ...
    private function getSection(int $iblockId, array $filter): ?array
    {
        $sections = \CIBlockSection::GetList(
            ...
            [
                ...
                'UF_KK_METRIKA_GOAL',
                'UF_KK_METRIKA_FIRST_ANSWER_GOAL',
                'UF_KK_METRIKA_RESULT_GOAL',
                'UF_KK_METRIKA_RESULT_CTA_GOAL',
                'UF_KK_METRIKA_PRODUCT_CLICK_GOAL',
                'UF_KK_USE_METRIKA',
                'UF_KK_USE_GA',
                'UF_KK_GA_MEASUREMENT_ID',
                'UF_KK_GA_FIRST_ANSWER_EVENT',
                'UF_KK_GA_RESULT_EVENT',
                'UF_KK_GA_RESULT_CTA_EVENT',
                'UF_KK_GA_PRODUCT_CLICK_EVENT',
                'UF_KK_GA_FORM_SUBMIT_EVENT',
                'UF_KK_USE_CATALOG',
    ...
    private function buildQuiz(int $iblockId, array $section): array
    {
        ...
        return [
            ...
            'metrika_goal' => trim((string)($section['UF_KK_METRIKA_GOAL'] ?? '')),
            'metrika_first_answer_goal' => trim((string)($section['UF_KK_METRIKA_FIRST_ANSWER_GOAL'] ?? '')),
            'metrika_result_goal' => trim((string)($section['UF_KK_METRIKA_RESULT_GOAL'] ?? '')),
            'metrika_result_cta_click_goal' => trim((string)($section['UF_KK_METRIKA_RESULT_CTA_GOAL'] ?? '')),
            'metrika_product_click_goal' => trim((string)($section['UF_KK_METRIKA_PRODUCT_CLICK_GOAL'] ?? '')),
            'use_metrika' => $this->toBool($section['UF_KK_USE_METRIKA'] ?? null),
            'use_ga' => $this->toBool($section['UF_KK_USE_GA'] ?? null),
            'ga_measurement_id' => trim((string)($section['UF_KK_GA_MEASUREMENT_ID'] ?? '')),
            'ga_first_answer_event_name' => trim((string)($section['UF_KK_GA_FIRST_ANSWER_EVENT'] ?? '')),
            'ga_result_event_name' => trim((string)($section['UF_KK_GA_RESULT_EVENT'] ?? '')),
            'ga_result_cta_click_event_name' => trim((string)($section['UF_KK_GA_RESULT_CTA_EVENT'] ?? '')),
            'ga_product_click_event_name' => trim((string)($section['UF_KK_GA_PRODUCT_CLICK_EVENT'] ?? '')),
            'ga_form_submit_event_name' => trim((string)($section['UF_KK_GA_FORM_SUBMIT_EVENT'] ?? '')),
