...
foreach ([$documentRoot . '/local/modules/kk.quiz/admin/element_edit.php', $documentRoot . '/bitrix/modules/kk.quiz/admin/element_edit.php'] as $path) {
...
echo 'KK Quiz element edit page not found.';
