...
$deleteUrl = 'kk_quiz_delete.php?' . http_build_query(['ID' => $sectionId, 'lang' => $lang]);
...
if (!$isCreateMode) {
    $contextItems[] = ['TEXT' => 'Схема', 'LINK' => $schemaUrl];
    ...
    $contextItems[] = ['SEPARATOR' => true];
    $contextItems[] = ['TEXT' => 'Удалить', 'LINK' => $deleteUrl];
}
