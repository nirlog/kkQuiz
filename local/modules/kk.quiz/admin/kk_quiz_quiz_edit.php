...
foreach ([$documentRoot . '/local/modules/kk.quiz/admin/quiz_edit.php', $documentRoot . '/bitrix/modules/kk.quiz/admin/quiz_edit.php'] as $path) {
    if (is_file($path)) {
        require_once $path;
        return;
    }
...
echo 'KK Quiz settings page not found.';
