...
foreach ([$documentRoot . '/local/modules/kk.quiz/admin/quizzes.php', $documentRoot . '/bitrix/modules/kk.quiz/admin/quizzes.php'] as $path) {
    if (is_file($path)) {
        require_once $path;
        return;
    }
...
echo 'KK Quiz list page not found.';
