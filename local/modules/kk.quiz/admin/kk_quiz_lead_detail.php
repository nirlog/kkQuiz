...
foreach ([
    $documentRoot . '/local/modules/kk.quiz/admin/lead_detail.php',
    $documentRoot . '/bitrix/modules/kk.quiz/admin/lead_detail.php',
] as $path) {
    if (is_file($path)) {
        require_once $path;
        return;
...
echo 'KK Quiz lead detail page not found.';
