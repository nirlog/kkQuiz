...
foreach ([
    $documentRoot . '/local/modules/kk.quiz/admin/lead_analytics.php',
    $documentRoot . '/bitrix/modules/kk.quiz/admin/lead_analytics.php',
] as $path) {
    if (is_file($path)) {
        require_once $path;
        return;
...
echo 'KK Quiz lead analytics page not found.';
